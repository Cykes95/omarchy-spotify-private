  ...
  Column {
    ...
    Row {
      ...
      TextField {
        ...
        placeholderText: "Filtrar esta lista"
      ...
      Text {
        ...
        text: root.visibleItems.length
          + (root.filterText ? (root.visibleItems.length === 1 ? " coincidencia" : " coincidencias")
            : (root.visibleItems.length === 1 ? " elemento" : " elementos"))
        color: Color.muted
    ...
    Button {
      ...
      text: root.loading ? "Cargando…" : "Cargar más"
      foreground: Color.foreground
  ...
  BorderSurface {
    ...
    Row {
      ...
      Column {
        ...
        Text {
          width: parent.width
          text: root.dragItem ? String(root.dragItem.name || "Sin título") : ""
