...
Item {
  ...
  function applyDiscovery(raw) {
    ...
    for (var i = 0; i < payload.devices.length && next.length < 32; i++) {
      ...
      next.push({
        id: id,
        name: String(item.name || "Dispositivo de Spotify Connect").slice(0, 160),
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.discoveryResult = ""
        root.lastError = "No se pudieron encontrar dispositivos de Spotify Connect en esta red"
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.lastError = "No se pudo conectar a este dispositivo de Spotify Connect"
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.lastError = "No se pudo controlar este altavoz Sonos"
