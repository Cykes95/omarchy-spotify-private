...
BarWidget {
  ...
  readonly property bool iconOnly: !spotify || vertical || !spotify.hasMedia
    || barText === ""
  // Keep the bar clear until local playback has actually been requested.
  // The Super+Shift+M binding still opens the on-demand panel.
  visible: spotify && spotify.daemon && spotify.daemon.running
  ...
  readonly property var miniShortcutRows: [
    { keys: "Tab / flechas / HJKL", action: "Seleccionar un control" },
    { keys: "Intro", action: "Activar el botón seleccionado" },
    { keys: "Izquierda / Derecha", action: "Ajustar el control seleccionado" },
    { keys: "Espacio", action: "Reproducir o pausar" },
    { keys: "Ctrl+Izquierda / Derecha", action: "Pista anterior o siguiente" },
    { keys: "Mayús+Izquierda / Derecha", action: "Avanzar o retroceder 10 segundos" },
    { keys: "Ctrl+Arriba / Abajo", action: "Cambiar volumen" },
    { keys: "M", action: "Silenciar o restaurar volumen" },
    { keys: "Ctrl+S / Ctrl+R", action: "Aleatorio / repetición" },
    { keys: "Ctrl+Mayús+L", action: "Abrir letra" },
    { keys: "Ctrl+Mayús+A", action: "Abrir el artista actual" },
    { keys: "Ctrl+Mayús+B", action: "Abrir el álbum actual" },
    { keys: "O", action: "Abrir reproductor completo" },
    { keys: "Ctrl+H", action: "Ocultar las pistas de atajos" },
    { keys: "Ctrl+/", action: "Mostrar u ocultar esta ayuda" },
    { keys: "Rueda sobre el icono", action: "Pista anterior o siguiente" },
    { keys: "Clic central en el icono", action: "Reproducir o pausar" },
  ...
  function shutdownCompletely() {
    // Close the only visible surface first; otherwise the service's receiver
    // helper would correctly treat the open mini-player as a start request.
    close()
  ...
  function activateMiniAction(action) {
    ...
    else if (action === "shutdown") shutdownCompletely()
  ...
  KeyboardPanel {
    ...
    Item {
      ...
      Column {
        ...
        Text {
          width: parent.width
          text: root.spotify ? root.spotify.loginProgress : "Spotify no está disponible"
        ...
        Text {
          width: parent.width
          text: "Conecta aquí tu cuenta de Spotify. La reproducción en este equipo puede terminar de configurarse en segundo plano."
          color: root.muted
          font.family: root.bar ? root.bar.fontFamily : Style.font.family
        ...
        Row {
          ...
          Button {
            text: root.spotify && root.spotify.loginBusy
              ? "Preparando…" : "Configurar y continuar"
            iconText: "󰍂"
            foreground: root.foreground
        ...
        Column {
          ...
          Row {
            ...
            Text {
              ...
              text: root.spotify && root.spotify.title
                ? root.spotify.title : "No se está reproduciendo nada"
              color: root.foreground
              font.family: root.bar ? root.bar.fontFamily : Style.font.family
          ...
          CursorSurface {
            ...
            PanelToolTip {
              ...
              text: "Abrir artista · Ctrl+Mayús+A"
            }
            KeyHint {
              id: miniArtistHint
      ...
      Row {
        ...
        TransportButton {
          ...
          tooltipText: "Anterior · Ctrl+Izquierda"
          enabled: root.spotify && root.spotify.playbackControllable
        ...
        TransportButton {
          ...
          tooltipText: (root.spotify && root.spotify.playing ? "Pausar" : "Reproducir")
            + " · Space"
          enabled: root.spotify && root.spotify.playbackControllable
        ...
        TransportButton {
          ...
          tooltipText: "Siguiente · Ctrl+Derecha"
          enabled: root.spotify && root.spotify.playbackControllable
        ...
        TransportButton {
          ...
          tooltipText: "Repetir: " + Api.repeatModeLabel(root.spotify
        ...
        TransportButton {
          ...
          tooltipText: "Abrir letras en Omasing · Ctrl+Mayús+L"
      ...
      Row {
        ...
        Text {
          width: parent.width - openButton.width - shutdownButton.width - Style.space(12)
          anchors.verticalCenter: parent.verticalCenter
          text: !root.spotify ? "Spotify no está disponible"
            : (root.spotify.lastError !== "" ? root.spotify.lastError
            : (root.spotify.statusMessage !== "" ? root.spotify.statusMessage
            : (!root.spotify.accountConnected ? "Conecta Spotify para empezar"
            : (!root.spotify.fullyConnected
              ? (root.spotify.loginBusy ? root.spotify.loginProgress
                : "Cuenta conectada · termina la reproducción en Ajustes")
            : (root.spotify.useRemotePlayback
              ? (root.spotify.playing ? "Reproduciendo en " : "Conectado a ")
                + root.spotify.playbackDeviceName
              : (root.spotify.daemon.running ? "Reproduciendo en este equipo"
                : "Listo al pulsar reproducir"))))))
          color: root.muted
          font.family: root.bar ? root.bar.fontFamily : Style.font.family
          font.pixelSize: Style.font.caption
          elide: Text.ElideRight
        ...
        Button {
          ...
          iconText: "󰐥"
          foreground: Color.urgent
          hasCursor: root.miniCursorActive && root.miniCursor === "shutdown"
          tooltipText: "Apagar Spotify por completo"
          onClicked: root.shutdownCompletely()
          onHovered: function(on) { if (on) root.setMiniCursor("shutdown") }
        }
        ...
        Button {
          ...
          tooltipText: "Abrir reproductor completo · O"
      ...
      Column {
        ...
        Row {
          ...
          Button {
            ...
            tooltipText: "Cerrar ayuda de atajos · Ctrl+/ o Esc"
