...
Item {
  ...
  function start() {
    ...
    if (!binaryAvailable) {
      lastError = "La compatibilidad de reproducción todavía no está instalada"
      return
    }
    if (!unitAvailable) {
      lastError = "La compatibilidad de reproducción debe configurarse"
      return
    }
    lastError = ""
    busy = true
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 3) {
        ...
        root.busy = false
        root.lastError = "Los ajustes de reproducción tienen un nombre de dispositivo o calidad no válidos"
        return
      }
      if (exitCode !== 0 && exitCode !== 4)
        root.lastError = "No se pudieron actualizar los ajustes de reproducción"
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.lastError = "No se pudo iniciar la reproducción en este equipo"
      }
    }
  }
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      else root.lastError = "No se pudo detener la reproducción en este equipo"
    }
  }
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.lastError = "Spotify no pudo conectar la reproducción en este equipo. Inténtalo de nuevo"
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      if (exitCode === 0) {
        ...
        root.lastError = "No se pudo eliminar la sesión de reproducción guardada"
